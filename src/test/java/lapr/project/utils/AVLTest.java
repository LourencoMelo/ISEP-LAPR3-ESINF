...
//        Assertions.assertEquals(lExpected, instance2.inOrder(), "inOrder should be " + lExpected.toString());
//        Assertions.assertEquals(instance2.height(), 2, "height should be 2 ");
//        System.out.println("------------------------------------");
//
...
//        Assertions.assertEquals(lExpected, instance3.inOrder(), "inOrder should be " + lExpected.toString());
//        Assertions.assertEquals(instance3.height(), 2, "height should be 2 ");
//        System.out.println("------------------------------------");
//    }
//
//    /**
...
//        Assertions.assertEquals(lExpected, instance.inOrder(), "inOrder should be " + lExpected.toString());
//        Assertions.assertEquals(instance.height(), 2, "height should be 2 ");
//
//        //test Simple left rotation
//        instance.remove(2);
...
//        Assertions.assertEquals(lExpected, instance.inOrder(), "inOrder should be " + lExpected.toString());
//        Assertions.assertEquals(1, instance.height(), "height should be 1 ");
//
//        instance.remove(4);
//        lExpected = Collections.singletonList(8);
//        Assertions.assertEquals(lExpected, instance.inOrder(), "inOrder should be " + lExpected.toString());
//        Assertions.assertEquals(0, instance.height(), "height should be 1 ");
//
//        instance.remove(8);
...
//            instance2.insert(arr2[i]);
//        }
//        Assertions.assertEquals(instance, instance2, "equals! ");
//        instance2.remove(8);
//        Assertions.assertNotEquals(instance, instance2, "equals! ");
//    }
//}
